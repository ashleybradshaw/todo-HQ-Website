...
const bookClass =
  "font-jetbrains inline-flex h-11 w-full min-h-11 shrink-0 items-center justify-center rounded-[4px] border border-border-ide bg-[color-mix(in_srgb,var(--foreground)_8%,transparent)] px-4 py-2 text-xs text-on-tint transition-opacity hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--foreground)] sm:w-[11.75rem]";
  ...
  return (
    <div className="font-jetbrains flex flex-col gap-6 px-4 py-4 text-xs leading-5 lg:text-sm lg:leading-6">
      <div className="space-y-1">
        ...
        <p className="text-syn-keyword font-medium">{"export const discovery = {"}</p>
        <p className="text-syn-property pl-4">{"coffee: {"}</p>
        <p className="pl-8">
          <span className="text-syn-property">length: </span>
          <span className="text-syn-string font-medium">{'"15 min"'}</span>,
        </p>
        <p className="pl-8">
          <span className="text-syn-property">vibe: </span>
        ...
        <p className="text-syn-property pl-4">{"},"}</p>
        <p className="pl-4">
          <span className="text-syn-property">email: </span>
          <a
