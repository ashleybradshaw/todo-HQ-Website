...
export const OFFERING_SUMMARY =
  "Most teams just write code. We build the entire factory — autonomous agents, automated workflows, and production-ready applications including Repdaily, ReadyGo, and Contentic.";
